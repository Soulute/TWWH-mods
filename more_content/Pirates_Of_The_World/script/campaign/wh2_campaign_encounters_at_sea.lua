--NOTICE: This script overwrites the base game's script with the same name
--That means it will cause incompatabilities with any other mods that also overwrite this script.
--Known incompatabilities: Encounters at Derp
--Modifications from the vanilla script will include "PIERCEBUSTER" in a comment above the function.
...
---PIERCEBUSTER varied sea variables
local pirate_character
local sea_bandit_roll_result

---piercebuster find OvN/Barque functions
function isOvNHere()
    if core:is_mod_loaded("ovn_faction_araby") == true then
        return true
    else
        return false
    end
...
function isBarqueHere()
out("test3 - finding barque...")    
    if vfs.exists("script/cr_tomb_barque_dummy.lua") or vfs.exists("script/export_helpers_Golden_Scarab_Custom_Dilemmas.lua")
            then
out("test4 - barque here")
        return true
    else
out("test5 - barque not here")
        return false
    end
end
...
function GenerateEncounterPirate(character, loc, unit)
    ...
    ---PIERCEBUSTER varied seas
    local pirate_name_roll
    
    if sea_bandit_roll_result == 1 then
        pirate_character = "dwf_lord"
        forename = "names_name_776610561"
        clan_name = ""
        family_name = ""
        other_name = ""
    end;
    if sea_bandit_roll_result == 2 then
        pirate_character = "wh2_dlc14_skv_master_assassin"
        forename = "names_name_776610562"
        clan_name = ""
        family_name = ""
        other_name = ""
    end;
    if sea_bandit_roll_result == 3 then
        pirate_character = "wh2_main_skv_warlord"
        forename = "names_name_776610563"
        clan_name = ""
        family_name = ""
        other_name = ""
    end;
    if sea_bandit_roll_result == 4 or sea_bandit_roll_result == 5 then
        pirate_character = "grn_orc_warboss"
        clan_name = ""
        family_name = ""
        other_name = ""
        pirate_name_roll = cm:random_number(3)
        if pirate_name_roll == 1 then
            forename = "names_name_776610564"
            end;
        if pirate_name_roll == 2 then
            forename = "names_name_776610565"
            end;
        if pirate_name_roll == 3 then
            forename = "names_name_776610566"    
            end;
    end;
    if sea_bandit_roll_result == 6 or sea_bandit_roll_result == 7 or sea_bandit_roll_result == 8 then
        pirate_character = "nor_marauder_chieftain"
        clan_name = ""
        family_name = ""
        other_name = ""
        pirate_name_roll = cm:random_number(4)
        if pirate_name_roll == 1 then
            forename = "names_name_776610567"
            end;
        if pirate_name_roll == 2 then
            forename = "names_name_776610568"
            end;
        if pirate_name_roll == 3 then
            forename = "names_name_776610569"    
            end;
        if pirate_name_roll == 4 then
            forename = "names_name_776610570"
        end;
    end;
    if sea_bandit_roll_result == 9 or sea_bandit_roll_result == 10 or sea_bandit_roll_result == 11 then
        pirate_character = "emp_lord"
        clan_name = ""
        family_name = ""
        other_name = ""
        pirate_name_roll = cm:random_number(4)
        if pirate_name_roll == 1 then
            forename = "names_name_776610571"
            end;
        if pirate_name_roll == 2 then
            forename = "names_name_776610572"
            end;
        if pirate_name_roll == 3 then
            forename = "names_name_776610573"    
            end;
        if pirate_name_roll == 4 then
            forename = "names_name_776610574"
        end;
    end;
    if sea_bandit_roll_result == 12 or sea_bandit_roll_result == 13 or sea_bandit_roll_result == 14 or sea_bandit_roll_result == 15 then
        pirate_character = "wh2_main_def_dreadlord"
        clan_name = ""
        family_name = ""
        other_name = ""
        pirate_name_roll = cm:random_number(5)
        if pirate_name_roll == 1 then
            forename = "names_name_776610575"
            end;
        if pirate_name_roll == 2 then
            forename = "names_name_776610576"
            end;
        if pirate_name_roll == 3 then
            forename = "names_name_776610577"    
            end;
        if pirate_name_roll == 4 then
            forename = "names_name_776610578"
            end;
        if pirate_name_roll == 5 then
            forename = "names_name_776610579"
        end;
    end;
    if sea_bandit_roll_result == 16 or sea_bandit_roll_result == 17 or sea_bandit_roll_result == 18 or sea_bandit_roll_result == 19 then
        pirate_character = "wh2_dlc11_cst_admiral_deep"
        clan_name = ""
        family_name = ""
        other_name = ""
        pirate_name_roll = cm:random_number(5)
        if pirate_name_roll == 1 then
            forename = "names_name_776610580"
            end;
        if pirate_name_roll == 2 then
            forename = "names_name_776610581"
            end;
        if pirate_name_roll == 3 then
            forename = "names_name_776610582"    
            end;
        if pirate_name_roll == 4 then
            forename = "names_name_776610583"
            end;
        if pirate_name_roll == 5 then
            forename = "names_name_776610584"
        end;
    end;
    if sea_bandit_roll_result == 20 or sea_bandit_roll_result == 21 or sea_bandit_roll_result == 22 or sea_bandit_roll_result == 23 then
        pirate_character = "ovn_araby_ll"
        clan_name = ""
        family_name = ""
        other_name = ""
        pirate_name_roll = cm:random_number(5)
        if pirate_name_roll == 1 then
            forename = "names_name_776610585"
            end;
        if pirate_name_roll == 2 then
            forename = "names_name_776610586"
            end;
        if pirate_name_roll == 3 then
            forename = "names_name_776610587"    
            end;
        if pirate_name_roll == 4 then
            forename = "names_name_776610588"
            end;
        if pirate_name_roll == 5 then
            forename = "names_name_776610589"
        end;
    end;
    if sea_bandit_roll_result == 24 or sea_bandit_roll_result == 25 then
        pirate_character = "elo_liche_general"
        clan_name = ""
        family_name = ""
        other_name = ""
        pirate_name_roll = cm:random_number(3)
        if pirate_name_roll == 1 then
            forename = "names_name_776610590"
            end;
        if pirate_name_roll == 2 then
            forename = "names_name_776610591"
            end;
        if pirate_name_roll == 3 then
            forename = "names_name_776610592"    
            end;
    end;
    
    invasion_1:create_general(false, pirate_character, forename, clan_name, family_name, other_name)
    --end PIERCEBUSTER var
...
---PIERCEBUSTER ANYNDEL VARIED SEA ENCOUNTERS
function DeclareArmyEncounters()
out("declaring sea encounter army!")
random_army_manager:remove_force("encounter_force")
out("test1")
local sea_bandit_army_roll
if isOvNHere() == false then
        sea_bandit_army_roll = cm:random_number(19)
elseif isOvNHere() == true and isBarqueHere() == false then
        sea_bandit_army_roll = cm:random_number(23)
        out("test rolling rn 23")
elseif isOvNHere() == true and isBarqueHere() == true then
        out("test rolling rn 25")
        sea_bandit_army_roll = cm:random_number(25)
end
out("testFifty")
sea_bandit_roll_result = sea_bandit_army_roll
out("test2")
out("Next army will be "..sea_bandit_army_roll)
out("test3")
if sea_bandit_army_roll == 1 then
        random_army_manager:new_force("encounter_force");
        random_army_manager:add_mandatory_unit("encounter_force", "wh_main_dwf_inf_longbeards_1", 3);
        random_army_manager:add_mandatory_unit("encounter_force", "wh_main_dwf_inf_longbeards", 2);
        random_army_manager:add_mandatory_unit("encounter_force", "wh_main_dwf_inf_slayers", 2);
        random_army_manager:add_mandatory_unit("encounter_force", "wh2_dlc10_dwf_inf_giant_slayers", 1);
        random_army_manager:add_mandatory_unit("encounter_force", "wh_main_dwf_inf_hammerers", 1);
        random_army_manager:add_mandatory_unit("encounter_force", "wh_main_dwf_inf_irondrakes_2",3);
        random_army_manager:add_mandatory_unit("encounter_force", "wh_main_dwf_inf_thunderers_0", 2);
        random_army_manager:add_mandatory_unit("encounter_force", "wh_main_dwf_art_cannon", 3);
        random_army_manager:add_mandatory_unit("encounter_force", "wh_main_dwf_art_organ_gun", 2);
end;
if sea_bandit_army_roll == 2 then
        random_army_manager:new_force("encounter_force");
        random_army_manager:add_mandatory_unit("encounter_force", "wh2_main_skv_cha_assassin", 1);
        random_army_manager:add_mandatory_unit("encounter_force", "wh2_dlc14_skv_inf_eshin_triads_0", 6);
        random_army_manager:add_mandatory_unit("encounter_force", "wh2_main_skv_inf_death_runners_0", 1);
        random_army_manager:add_mandatory_unit("encounter_force", "wh2_main_skv_inf_night_runners_0", 5);
        random_army_manager:add_mandatory_unit("encounter_force", "wh2_dlc14_skv_inf_poison_wind_mortar_0", 3);
        random_army_manager:add_mandatory_unit("encounter_force", "wh2_dlc16_skv_mon_wolf_rats_1",1);
end;
if sea_bandit_army_roll == 3 then
        random_army_manager:new_force("encounter_force");
...
if sea_bandit_army_roll == 4 or sea_bandit_army_roll == 5 then
        random_army_manager:new_force("encounter_force");
...
if sea_bandit_army_roll == 6 or sea_bandit_army_roll == 7 or sea_bandit_army_roll == 8 then
		random_army_manager:new_force("encounter_force");
...
if sea_bandit_army_roll == 9 or sea_bandit_army_roll == 10 or sea_bandit_army_roll == 11 then
		random_army_manager:new_force("encounter_force");
		random_army_manager:add_mandatory_unit("encounter_force", "wh_dlc04_emp_inf_free_company_militia_0", 2);
		random_army_manager:add_mandatory_unit("encounter_force", "wh_main_emp_inf_handgunners", 2);
		random_army_manager:add_unit("encounter_force", "wh_main_emp_inf_swordsmen", 2);
		random_army_manager:add_unit("encounter_force", "wh_main_emp_inf_spearmen_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc13_emp_inf_archers_0", 1);
		random_army_manager:add_unit("encounter_force", "wh_main_emp_inf_crossbowmen", 1);
		random_army_manager:add_unit("encounter_force", "wh_dlc04_emp_inf_free_company_militia_0", 2);
		random_army_manager:add_unit("encounter_force", "wh_main_emp_inf_handgunners", 2);
		random_army_manager:add_unit("encounter_force", "wh_main_emp_cav_outriders_0", 1);
		random_army_manager:add_unit("encounter_force", "wh_main_emp_cav_outriders_1", 1);
		random_army_manager:add_unit("encounter_force", "wh_main_emp_cav_pistoliers_1", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc13_emp_veh_war_wagon_1", 1);
		random_army_manager:add_unit("encounter_force", "wh_main_emp_art_mortar", 2);
		random_army_manager:add_unit("encounter_force", "wh_main_emp_art_great_cannon", 2);
		random_army_manager:add_unit("encounter_force", "wh_main_emp_art_helblaster_volley_gun", 1);
		random_army_manager:add_unit("encounter_force", "wh2_twa05_ogr_inf_maneaters_3", 1);
		random_army_manager:add_unit("encounter_force", "wh2_twa05_ogr_inf_ogres_0", 2);
end;
if sea_bandit_army_roll == 12 or sea_bandit_army_roll == 13 or sea_bandit_army_roll == 14 or sea_bandit_army_roll == 15 then
		random_army_manager:new_force("encounter_force");
		random_army_manager:add_mandatory_unit("encounter_force", "wh2_main_def_inf_black_ark_corsairs_0", 2);
		random_army_manager:add_mandatory_unit("encounter_force", "wh2_main_def_inf_black_ark_corsairs_1", 2);
		random_army_manager:add_unit("encounter_force", "wh2_twa05_ogr_inf_maneaters_3", 1);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_inf_bleakswords_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_inf_har_ganeth_executioners_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_inf_harpies", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc10_def_mon_kharibdyss_0", 2);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_inf_darkshards_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_inf_darkshards_1", 1);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_inf_shades_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_inf_shades_1", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc10_def_cav_doomfire_warlocks_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_cav_dark_riders_2", 1);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_cav_dark_riders_0", 1);		random_army_manager:add_unit("encounter_force", "wh2_main_def_art_reaper_bolt_thrower", 2);
        random_army_manager:add_unit("encounter_force", "wh2_dlc14_def_cha_master_1", 1);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_inf_black_ark_corsairs_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_main_def_inf_black_ark_corsairs_1", 1);
end;
if sea_bandit_army_roll == 16 or sea_bandit_army_roll == 17 or sea_bandit_army_roll == 18 or sea_bandit_army_roll == 19 then
        random_army_manager:new_force("encounter_force");
		random_army_manager:add_mandatory_unit("encounter_force", "wh2_dlc11_cst_art_carronade", 1);
		random_army_manager:add_mandatory_unit("encounter_force", "wh2_dlc11_cst_art_mortar", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_mon_bloated_corpse_0", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_mon_rotting_leviathan_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_inf_depth_guard_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_inf_depth_guard_1", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_mon_scurvy_dogs", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_inf_syreens", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_mon_terrorgheist", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_inf_zombie_deckhands_mob_0", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_inf_zombie_deckhands_mob_1", 2);		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_inf_zombie_gunnery_mob_2", 2);
        random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_inf_zombie_gunnery_mob_3", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_mon_necrofex_colossus_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_inf_deck_gunners_0", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_mon_rotting_prometheans_gunnery_mob_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_inf_zombie_gunnery_mob_0", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_inf_zombie_gunnery_mob_1", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_cav_deck_droppers_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_cav_deck_droppers_1", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_cav_deck_droppers_2", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_art_carronade", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_art_mortar", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc11_cst_cha_gunnery_wight_0", 1);
end;
if sea_bandit_army_roll == 20 or sea_bandit_army_roll == 21 or sea_bandit_army_roll == 22 or sea_bandit_army_roll == 23 then
        random_army_manager:new_force("encounter_force");
		random_army_manager:add_unit("encounter_force", "ovn_arb_art_trebuchet", 1);
		random_army_manager:add_unit("encounter_force", "akp_brt_ballista", 1);
		random_army_manager:add_unit("encounter_force", "ovn_arb_art_grand_bombard", 1);
		random_army_manager:add_unit("encounter_force", "OtF_khemri_archers", 2);
		random_army_manager:add_unit("encounter_force", "OtF_khemri_swordsmen", 2);
		random_army_manager:add_unit("encounter_force", "ovn_corsairs", 2);
		random_army_manager:add_unit("encounter_force", "ovn_slave", 2);
		random_army_manager:add_unit("encounter_force", "ovn_jez", 2);        
        random_army_manager:add_mandatory_unit("encounter_force", "ovn_corsairs", 2);
		random_army_manager:add_mandatory_unit("encounter_force", "ovn_slave", 1);
		random_army_manager:add_mandatory_unit("encounter_force", "ovn_jez", 1);
		random_army_manager:add_unit("encounter_force", "ovn_glad", 1);
        random_army_manager:add_unit("encounter_force", "sr_ogre_arb", 1);
		random_army_manager:add_unit("encounter_force", "wh_main_arb_cav_magic_carpet_0", 1);
		random_army_manager:add_unit("encounter_force", "ovn_cat_knights", 1);
		random_army_manager:add_unit("encounter_force", "ovn_arb_mon_sea_nymph", 1);
		random_army_manager:add_unit("encounter_force", "wh2_twa05_ogr_inf_maneaters_3", 1);
		random_army_manager:add_unit("encounter_force", "wh2_twa05_ogr_inf_ogres_1", 1);
end
if sea_bandit_army_roll == 24 or sea_bandit_army_roll == 25 then
        random_army_manager:new_force("encounter_force");
		random_army_manager:add_mandatory_unit("encounter_force", "wh2_dlc09_tmb_inf_nehekhara_warriors_0", 2);
		random_army_manager:add_mandatory_unit("encounter_force", "wh2_dlc09_tmb_inf_skeleton_archers_0", 2);
		random_army_manager:add_mandatory_unit("encounter_force", "cr_tmb_veh_tomb_barque_0", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_inf_skeleton_warriors_0", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_inf_tomb_guard_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_mon_carrion_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_mon_ushabti_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_mon_sepulchral_stalkers_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_mon_ushabti_1", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_cav_nehekhara_horsemen_0", 1);        
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_cav_skeleton_horsemen_archers_0", 1);
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_art_screaming_skull_catapult_0", 1);
		random_army_manager:add_unit("encounter_force", "cr_tmb_veh_tomb_barque_0", 3);
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_inf_nehekhara_warriors_0", 2);
		random_army_manager:add_unit("encounter_force", "wh2_dlc09_tmb_inf_skeleton_archers_0", 2);
end;
end

core:add_listener(
	"area_entered_trigger_varied_encounters_at_sea",
	"AreaEntered",
	true,
	function(context)
		...
		local faction = character:faction();
		local faction_name = faction:name();
		if cm:char_is_general_with_army(character) and string.find(area_key, "marker") then
		DeclareArmyEncounters()
		end;
	end,
	true
);
...
core:add_listener(
	"faction_turn_start_declare_varied_sea_enc",
	"FactionTurnStart",
